...
**Mouse Ring** Draws a configurable ring around your cursor so you always know exactly where it is on screen. Options include:

*   **Size** - slider from 20 to 200 pixels
*   **Class Color** - tints the ring your class color automatically
*   **Hide Center Dot** - remove the small center dot if you prefer a cleaner look
*   **Only in Combat** - ring only appears when you are in combat, keeping your screen clear otherwise
*   **Only on Right-Click** - ring is only visible while the right mouse button is held (useful for camera turning)
*   **Cast Progress** - a second ring sweeps around the outside of the cursor ring to show the progress of your current cast or channel, similar to a cast bar but centered on your mouse

***

**Vendor Automation** Removes the busywork of visiting a merchant:
