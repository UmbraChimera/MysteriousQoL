...
function addon.MI_Bloodlust_RegisterSettings(funCat)
    local function GetSoundOptions()
        ...
        container:Add("r2d2.ogg", "R2-D2")
        container:Add("wei.ogg",  "Wei")
    ...
    addon.settings.Dropdown(
        funCat,
        "fun_bloodlust_sound",
        "Bloodlust Sound Choice",
        GetSoundOptions,
        "Which sound to play when Bloodlust is applied.",
        function() played = false end
    )
    addon.settings.Dropdown(
        funCat,
